"""
Make sure u understand the game 
Then use the strategy of a simulate that plays one round of the game 
You need to draw cards 
  use randint(1,13) to simulate drawing a card 
  This is not quite the same as drawing out fo a deck but it will work for us 

  there are two possible bets: player and banker 

  Start by testing whether the player hand wins 
  you can then test wheter the Banker hand wins 
"""
